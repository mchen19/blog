...
;(function (window, document, $, undefined) {
    ...
    var defaults = {
        ...
        btnTpl : {
            ...
            download : '<a download data-fancybox-download class="fancybox-button fancybox-button--download" title="">' +
...
;(function (document, $) {
	...
	$.extend(true, $.fancybox.defaults, {
		btnTpl : {
			fullScreen :
				'<button data-fancybox-fullscreen class="fancybox-button fancybox-button--fullscreen" title="">' +
					'<svg viewBox="0 0 40 40">' +
...
;(function (document, $) {
	...
	$.fancybox.defaults = $.extend(true, {
		btnTpl : {
			thumbs :
			'<button data-fancybox-thumbs class="fancybox-button fancybox-button--thumbs" title="">' +
...
;(function (document, $) {
	...
	$.extend(true, $.fancybox.defaults, {
		btnTpl : {
			share :
				'<button data-fancybox-share class="fancybox-button fancybox-button--share" title="">' +
					'<svg viewBox="0 0 40 40">' +
		...
		share : {
			tpl :
				'<div class="fancybox-share">' +
					'<h1></h1>' +
					'<p>' +
						'<a href="https://www.facebook.com/sharer/sharer.php?u=" target="_blank" class="fancybox-share_button">' +
							...
							'<span>Facebook</span>' +
						'</a>' +
						'<a href="https://www.pinterest.com/pin/create/button/?url=&amp;description=" target="_blank" class="fancybox-share_button">' +
							...
							'<span>Pinterest</span>' +
						'</a>' +
						'<a href="https://twitter.com/intent/tweet?url=&amp;text=" target="_blank" class="fancybox-share_button">' +
						...
						'</a>' +
					'</p>' +
					'<p><input type="text" value="" onfocus="this.select()" /></p>' +
				'</div>'
		}
	});
